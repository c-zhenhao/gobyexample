...
func main() {
	...
	t := time.Now()
	p(t.Format(time.RFC3339)) // -> 2022-09-11T11:01:49+08:00
	...
	p(t.Format("3:04PM"))                           // -> 11:01AM
	p(t.Format("Mon Jan _2 15:04:05 2006"))         // -> Sun Sep 11 11:01:49 2022
	p(t.Format("2006-01-02T15:04:05.999999-07:00")) // -> 2022-09-11T11:01:49.860399+08:00
	form := "3 04 PM"
	...
	fmt.Printf("%d-%02d-%02dT%02d:%02d:%02d-00:00\n",
		...
		t.Hour(), t.Minute(), t.Second()) // -> 2022-09-11T11:01:49-00:00

...
func main() {
	...
	fmt.Println("p:", p) // -> in linux: dir1/dir2/filename | in windows: dir1\dir2\filename
	...
	fmt.Println(filepath.Join("dir1//", "filename"))       // -> in linux: dir1/filename | in windows: dir1\filename
	fmt.Println(filepath.Join("dir1/../dir1", "filename")) // -> in linux: dir1/filename | in windows: dir1\filename
	...
	fmt.Println("Dir(p):", filepath.Dir(p))   // -> in linux: Dir(p): dir1/dir2 | in windows: Dir(p): dir1\dir2
	fmt.Println("Base(p):", filepath.Base(p)) // -> in linux: Base(p): filename | in windows: Base(p): filename
	...
	fmt.Println(rel) // -> in linux: t/file | in windows: t\file

	rel, err = filepath.Rel("a/b", "a/c/t/file")
	if err != nil {
		panic(err)
	}
	fmt.Println(rel) // -> in linux: ../c/t/file | in windows: ..\c\t\file
}
